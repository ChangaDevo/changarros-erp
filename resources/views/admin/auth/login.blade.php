...
<head>
  ...
  <title>Iniciar Sesión - Changarrito OS Admin</title>
              ...
              <div class="row">
                <div class="col-md-4 pe-md-0">
                  <div class="auth-side-wrapper d-flex flex-column align-items-center justify-content-center p-4"
                    ...
                    <div class="text-center text-white">
                      <h3 class="fw-bold mb-2">Changarrito<br><span style="opacity:0.8">OS</span></h3>
                ...
                <div class="col-md-8 ps-md-0">
                  <div class="auth-form-wrapper px-4 py-5">
                    <a href="#" class="nobleui-logo d-block mb-2">Changarrito<span>OS</span></a>
                    ...
                    <form method="POST" action="{{ route('admin.login.submit') }}">
                      ...
                      <div class="mb-3">
                        ...
                        <input type="email" class="form-control @error('email') is-invalid @enderror"
                          ...
                          placeholder="admin@changarrito.com" required autofocus>
                        @error('email')
