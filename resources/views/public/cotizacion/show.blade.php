...
<head>
  ...
  <title>Cotización: {{ $cotizacion->nombre }} — Changarrito</title>
...
<div class="cot-header">
  <div class="cot-header-inner">
    <a class="brand-logo" href="#">Changarrito<span>OS</span></a>
...
<div class="cot-body">
  ...
  <div class="banner banner-success">
    ...
    <p class="mt-1 mb-0" style="color:#166534;font-size:.9rem;">
      ...
      El equipo de Changarrito se pondrá en contacto pronto.
    </p>
  </div>
...
<div class="cot-footer">
  <p>Preparado por <strong>Changarrito Estudio Creativo</strong> · Cotización generada el {{ $cotizacion->created_at->format('d M Y') }}</p>
  <p>¿Preguntas? Contáctanos · <a href="mailto:hola@changarrito.mx">hola@changarrito.mx</a></p>
</div>
...
<div class="modal-overlay" id="modalApprove">
  <div class="modal-box">
    ...
    <p style="color:#6b7280;font-size:.9rem;margin-bottom:1.25rem;">
      Al aprobar, autorizas a Changarrito a iniciar los trabajos descritos en esta cotización por un total de
